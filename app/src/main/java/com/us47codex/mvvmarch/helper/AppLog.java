...
public class AppLog {
    ...
    private static String HOST = EndPoints.BASE_URL;
    ...
    public static void errorFCR(String title, Throwable t) {
        if (AppLog.DO_LOG) {
            Log.e(Constants.APP_NAME + " HOST :: " + HOST, title, t);
        }
//        if (AppLog.DO_FCR) {
//            Crashlytics.logException(new Exception(Constants.APP_NAME + " HOST :: " + HOST + " Title :: " + title, t));
//            try {
//                Crashlytics.logException(new Exception(Constants.APP_NAME + " HOST :: " + HOST + " Title :: " + title, t));
//            } catch (Exception e) {
//                Crashlytics.logException(new Exception(Constants.APP_NAME + " HOST :: " + HOST + " Title :: " + title + " ", t));
//                Crashlytics.logException(new Exception(Constants.APP_NAME + " HOST :: " + HOST + " Title :: " + title + " ", e));
//            }
//        }
    }
    ...
    public static void errorFCR(Throwable t) {
        if (AppLog.DO_LOG) {
            Log.e(Constants.APP_NAME, " HOST :: " + HOST, t);
        }
//        if (AppLog.DO_FCR) {
//            try {
//                Crashlytics.logException(new Exception(Constants.APP_NAME + " HOST :: " + HOST, t));
//            } catch (Exception e) {
//                Crashlytics.logException(new Exception(Constants.APP_NAME + " HOST :: " + HOST + " ", t));
//                Crashlytics.logException(new Exception(Constants.APP_NAME + " HOST :: " + HOST + " ", e));
//            }
//        }
    }
}